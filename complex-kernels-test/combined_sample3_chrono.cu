...
void runWithoutGraph(float* totalTimeWith, float* totalTimeWithout, float* chronoTotalTimeWith, float* chronoTotalTimeWithout, float* chronoTotalLunchTimeWith, float* chronoTotalLunchTimeWithout, int nstep, int skipby) {
    ...
    *chronoTotalTimeWith = totalTimeWithChrono.count() * 1000;
    *chronoTotalTimeWithout = totalTimeChrono.count() * 1000;
    *chronoTotalLunchTimeWith = totalLunchTimeWithChrono.count() * 1000;
    *chronoTotalLunchTimeWithout = totalLunchTimeChrono.count() * 1000;
}

// Function for graph implementation
void runWithGraph(float* totalTimeWith, float* totalTimeWithout, float* chronoTotalTimeWith, float* chronoTotalTimeWithout, float* chronoTotalLunchTimeWith, float* chronoTotalLunchTimeWithout, int nstep, int skipby) {
    // Declare constants inside the function
    const int NSTEP = nstep;
    const int SKIPBY = skipby;
    ...
    // std::chrono::duration<double> graphCreateTimeChrono = std::chrono::duration<double>(0.0);
...
int main(int argc, char* argv[]) {
    ...
    float chronoNonGraphTotalTimeWith, chronoNonGraphTotalTimeWithout;
    float chronoNonGraphTotalLunchTimeWith, chronoNonGraphTotalLunchTimeWithout;
    // float nonGraphTotalTime = runWithoutGraph(N);
    runWithoutGraph(&nonGraphTotalTime, &nonGraphTotalTimeWithout, 
                &chronoNonGraphTotalTimeWith, &chronoNonGraphTotalTimeWithout, 
                &chronoNonGraphTotalLunchTimeWith, &chronoNonGraphTotalLunchTimeWithout, 
                NSTEP, SKIPBY);

    // Measure time for graph implementation
    float graphTotalTime, graphTotalTimeWithout;
    float chronoGraphTotalTimeWith, chronoGraphTotalTimeWithout;
    float chronoGraphTotalLunchTimeWith, chronoGraphTotalLunchTimeWithout;
    // float graphTotalTime = runWithGraph(N);
    runWithGraph(&graphTotalTime, &graphTotalTimeWithout, &chronoGraphTotalTimeWith, &chronoGraphTotalTimeWithout, &chronoGraphTotalLunchTimeWith, &chronoGraphTotalLunchTimeWithout, NSTEP, SKIPBY);
    ...
    // Chrono Lunch + Exec Time 
    float chronoDiffTotalTimeWith = chronoNonGraphTotalTimeWith - chronoGraphTotalTimeWith;
    float chronoDiffTotalTimeWithout = chronoNonGraphTotalTimeWithout - chronoGraphTotalTimeWithout;
    
    float chronoDiffPerStepWith = chronoDiffTotalTimeWith / (NSTEP-1); 
    float chronoDiffPercentWith = (chronoDiffTotalTimeWith / chronoNonGraphTotalTimeWith) * 100;

    float chronoDiffPerStepWithout = chronoDiffTotalTimeWithout / (NSTEP-1); 
    float chronoDiffPercentWithout = (chronoDiffTotalTimeWithout / chronoNonGraphTotalTimeWithout) * 100;

    // Chrono Lunch Time
    float chronoDiffLunchTimeWith = chronoNonGraphTotalLunchTimeWith - chronoGraphTotalLunchTimeWith;
    float chronoDiffLunchTimeWithout = chronoNonGraphTotalLunchTimeWithout - chronoGraphTotalLunchTimeWithout;

    float chronoDiffLunchPercentWith = (chronoDiffLunchTimeWith / chronoNonGraphTotalLunchTimeWith) * 100;
    float chronoDiffLunchPercentWithout = (chronoDiffLunchTimeWithout / chronoNonGraphTotalLunchTimeWithout) * 100;

    // Print the differences
    std::cout << "=======Comparison without Graph Creation=======" << std::endl;
    std::cout << "Difference Launch Time: " << chronoDiffLunchTimeWithout << " ms" << std::endl;
    std::cout << "Difference Launch Percentage: " << chronoDiffLunchPercentWithout << "%" << std::endl;
    std::cout << "CHRONO Difference: " << chronoDiffTotalTimeWithout << " ms" << std::endl;
    std::cout << "CHRONO Difference per step: " << chronoDiffPerStepWithout << " ms" << std::endl;
    std::cout << "CHRONO Difference percentage: " << chronoDiffPercentWithout << "%" << std::endl;
    ...
    std::cout << "Difference Launch Time: " << chronoDiffLunchTimeWith << " ms" << std::endl;
    std::cout << "Difference Launch Percentage: " << chronoDiffLunchPercentWith << "%" << std::endl;
    std::cout << "CHRONO Difference: " << chronoDiffTotalTimeWith << " ms" << std::endl;
    std::cout << "CHRONO Difference per step: " << chronoDiffPerStepWith << " ms" << std::endl;
    std::cout << "CHRONO Difference percentage: " << chronoDiffPercentWith << "%" << std::endl;
